...
print(yemenplot)
# yemenplot = yemenplot + scale_colour_brewer(palette = "Set2")
# print(yemenplot)
```
...
```{r themes}
yemenplot+theme_minimal()
yemenplot+theme_classic()

library(ggthemes)
yemenplot+theme_tufte()
yemenplot+theme_fivethirtyeight()
```
