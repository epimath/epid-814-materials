...
library(twitteR)
### <b>
consumer_key <- "dd3vPkt9qPD9r3weHH1oWKsPM"
consumer_secret <- "c2H0WzOgTRjzcste8IPXlw3chkfJvl8BVLQHe37WMcnulRjq0l"
access_token <- "434221108-g7nOc0smbrB28oaUt43o9BP4GJzn2z6cYPGt7sJ1"
access_secret <- "qWNUsy8XiHiY4fZqIe15LMTpBE2rpkCgZk1Ss6H0KWzCR"
### </b>
...
library(Rfacebook)
fb_oauth <- fbOAuth(
  app_id="1596159733760349",
  app_secret="80ed4ac9263f22825fcb9e75c4138c67",
...
library(Rfacebook)
fb_oauth <- "EAACEdEose0cBAHq5BckCFOiiF7SWtZC9Jsbc21jVHMLUBp4hvRX5zt7aEx9JcEFQlSN85BBGps0VSQvXzaZAZBvwTUQqaIugV6K72UdZAZCRb6WEBtinDhUgJDkXOHMMEXGGQaPHYUonZATjz1umv2W4ZBAqaaSfdAsAtY2ppyyWF4lO11avbGnGLFpYz5WgcEZD"
getUsers("me",token=fb_oauth) #public profile
head(getLikes(user="me", token=fb_oauth)) #likes
updateStatus("hiho", fb_oauth) #fb post via R
