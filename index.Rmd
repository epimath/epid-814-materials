...
- Using R to pull data using API's - Twitter and Google Maps (also possibly facebook and google) (Yu-Han Kao)

  + [Data Scraping Lab Part 1](https://epimath.github.io/epid-814-materials/Labs/DataScrapingPart1/datascrpe_slides.html)

- <span style="color:#AAAAAA;"> General web-scraping (e.g. maybe MMWR, Promed/Healthmap, Wikipedia, Pubmed etc?)

- <span style="color:#AAAAAA;"> Google maps API?
<!-- stuff discussed
