...
- [Twitter data collection lab](Labs/DataScrapingPart1-Twitter/DataScraping-Twitter.html)
    ...
    - [Tutorial](https://alexluscombe.ca/post/r-pdftools/) for reading pdfs into R using the [pdftools package](https://cran.r-project.org/web/packages/pdftools/pdftools.pdf)
...
##### 7. Reproduction number - data driven approaches to $\mathcal{R}_0$ and $\mathcal{R}_t$
