...
- Guest lecture by Andrew Brouwer
    - [Slides](Lectures/AndrewGuestLectureR0/BrouwerR0Lecture.pdf)
    - [Exercises](Lectures/AndrewGuestLectureR0/Exercises.pdf)
...
- [Slides](Lectures/DataDrivenR0Rt.pdf)

- [Rt examples with Michigan COVID data](Labs/DataDrivenR0Rt/Rtexamples.R)

- [Rt examples with simulated data](Labs/DataDrivenR0Rt/Rtexamples2.R)

<br>


##### 10. Parallelization in R and Python 
- [Slides](Labs/Parallelization/ParallelComputing.html)

- [Code for R](Labs/Parallelization/ClassExampleParallelCode.R)

- [Code for Python](https://replit.com/@EisenbergUM/ParallelizationExample#main.py)
