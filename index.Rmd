...
* [Course Syllabus](Epid814_SyllabusF2021.pdf)
...
##### 1. Introduction and topics discussion (30 Aug 2021)
...
##### 5. Sampling-based approaches to global sensitivity analysis

- Latin hypercube and Sobol sampling

- Global sensitivity methods (maybe do as journal club with Marino et al. paper)

- Potentially: active subspace methods, surrogate models

<br>

##### 6. Reproduction number - data driven approaches to $\mathcal{R}_0$ and $\mathcal{R}_t$
...
##### 7. Reproduction number - next generation matrix approaches
...
##### 8. Data-scraping and data-wrangling 
...
##### 9. Basic intro to some useful algorithms/machine learning methods
